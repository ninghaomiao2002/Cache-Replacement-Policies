...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_M_AXI_BURST_LEN_LOG2" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_M_AXI_BURST_LEN_LOG2 { PARAM_VALUE.C_M_AXI_BURST_LEN_LOG2 } {
	# Procedure called to update C_M_AXI_BURST_LEN_LOG2 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_AXI_BURST_LEN_LOG2 { PARAM_VALUE.C_M_AXI_BURST_LEN_LOG2 } {
	# Procedure called to validate C_M_AXI_BURST_LEN_LOG2
	return true
}
...
proc update_MODELPARAM_VALUE.C_M_AXI_BURST_LEN_LOG2 { MODELPARAM_VALUE.C_M_AXI_BURST_LEN_LOG2 PARAM_VALUE.C_M_AXI_BURST_LEN_LOG2 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_AXI_BURST_LEN_LOG2}] ${MODELPARAM_VALUE.C_M_AXI_BURST_LEN_LOG2}
}
